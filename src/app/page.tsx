...
export default function Page() {
  return (
    <main className="flex flex-col min-h-[100dvh]">
        ...
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {DATA.skills.map((skill, id) => {
              ...
              return (
                  <BlurFade key={skill.name} delay={BLUR_FADE_DELAY + id * 0.02}>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm/relaxed xl:text-base/relaxed">
                  A selection of projects focused on backend systems and AI-driven applications.
                </p>
              </div>
            </div>
          </BlurFade>
      ...
      {/*            I’ve participated in {DATA.hackathons.length}+ hackathons, collaborating with students*/}
      {/*            from across the country to build projects.*/}
      {/*            Working under tight deadlines pushed me to think fast, collaborate better,*/}
      {/*            and turn rough ideas into working solutions.*/}
      {/*          </p>*/}
      {/*        </div>*/}
      {/*      </div>*/}
      {/*    </BlurFade>*/}
